...
* Create Cache connections in the Lucee web administrator to connect to any network-accessable Couchbase cluster
...
The Couchbase extension is installed as a Lucee extension into any Lucee Server version <span class="label label-warning">4.1.0.001</span> and above.  The extension can either be installed in the server context or a specific web context.  
